    ...
    <section class="su-section section-3">
        <div class="container">
            ...
            <div class="row mt-5">
                ...
                <div class="col-12 col-md-7 col-lg-7 offset-md-1">
                    <div class="tab-content" id="v-pills-tabContent">
                        ...
                        <div class="content-text"><h4>Ý TƯỞNG (27/08/2018 – 10/10/2018)</h4>
                            ...
                            <div class="content-text">
                                <p>Lịch trình Vòng 1:
                                    <br>
                                    Thời gian: Thí sinh chính thức nộp hồ sơ từ ngày <b>10/09/2018 – 05/10/2018</b>
                                </p>
                                <b>Hình thức:</b>
                                <ul>
                                    <li>Thi online, đăng ký và nộp ý tưởng thông qua website http://xstartup.zikzak-co.vn</li>
                                    <li>Nộp ý tưởng tham gia cho BTC bằng cách điền thông tin trên vào Form đăng ký trên website</li>
                                    <li>Bản tóm tắt ý tưởng kinh doanh (File PDF theo Mẫu: <a href="https://docs.google.com/document/d/1KjKAwC8LrFn4uIXk6mSq1LORQU0E1u6JCKwJ8Upszo0/edit?usp=sharing">Tóm tắt ý tưởng kinh doanh mẫu</a>)</li>
                                    <li>Video giới thiệu Nhóm và Ý tưởng (Video dài 3 - 5 phút). Nội dung video bao gồm: Giới thiệu nhóm, thành viên, ý tưởng, tính khả thi, tính vận hành, tính thực tế của ý tưởng.
                                    </li>
                                </ul>
                                <p><b>Kết quả Vòng 1</b>: chọn ra 60 dự án nổi bật nhất của 2 khu vực Bắc và Nam vào ngày 10/10/2018</p>
                                <b>Lưu ý:</b>
                                <ul>
                    ...
                    <div class="content-text">
                        ...
                        <p><b>Hình thức</b></p>
                        Thi Online, Video của các đội tham dự qua Vòng 1 sẽ được đăng tải trên Fanpage Zikzak co-working Space kèm theo tên Nhóm và Mã số dự thi, Các đội sẽ có nhiệm vụ like share tăng độ lan tỏa ý tưởng của mình.
                        <br>
                        60 đội có điểm số cao nhất sẽ đi tiếp vào Vòng 2 (30 đội khu vực miền Bắc và 30 đội khu vực miền Nam)
                        <br>
                        Cách thức tính điểm: Điểm số sẽ 50% do khán giả bình chọn và 50% do BGK chấm điểm. Điểm số tối đa 1 đội đạt được là 60 điểm, cụ thể như sau:
                        <br>
                        <br>
                ...
                <div class="content-text">
                    ...
                    <ul>
                        ...
                        <li>12/11/2018 Các đội khu vực miền Bắc trình bày, phản biện dự án kinh doanh của mình trước BGK tại khu vực miền Bắc.</li>
                        <li>15/11/2018 Các đội khu vực miền Nam trình bày, phản biện dự án kinh doanh của mình trước BGK tại  tại khu vực miền Nam</li>
                    ...
                    <b>*Lưu ý:</b>
                    <ul>
                        <li>10 đội khu vực miền Bắc sẽ trực tiếp thuyết phục BGK để được đi vào vòng Chung Kết bằng cách trực tiếp present trước BGK tại địa điểm</li>
            ...
            <div class="content-text">
                ...
                <b>Hình thức:</b>
                <ul>
                    <li>6 đội thi lọt vào vòng Chung Kết sẽ đối đầu trực tiếp với nhau và thuyết phục BGK, các vị khách mời, các nhà đầu tư cùng 1000 khán giả để giành lấy ngôi vị Quán quân danh giá.</li>
                        ...
                        <div class="tab-content" id="v-tabContent">
                            ...
                            <div class="content-text">
                                ...
                                <ul>
                                    ...
                                    <li>01 năm sử dụng miễn phí dịch vụ chỗ ngồi  tại Zikzak co-working Space cho cả đội</li>
                        ...
                        <div class="tab-pane fade" id="v-profile" role="tabpanel" aria-labelledby="v-profile-tab">
                            <div class="content-text">
                                ...
                                <ul>
                                    ...
                                    <li>Tặng 03 tháng sử dụng miễn phí dịch vụ chỗ ngồi tại zikzak co-working space cho cả đội</li>
